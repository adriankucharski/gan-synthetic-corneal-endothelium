...
if __name__ == '__main__':
    synthetic_dataset = generate_dataset(r'generator\models\20220330-1516\model_last.h5', num_of_data=128 * 1, batch_size=128)
    image, mask = synthetic_dataset
    for i in range(len(image)):
        rgamma = np.random.uniform(0.5, 1.5)
    ...
    # unet.train(50, synthetic_dataset, validation_data, validation_split=0.1)